...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row row-cols-1 row-cols-md video " data-section="section5" style="background-image: url('{{asset('homepage/assets/images/video-bg.jpg')}}')">
            <input type="hidden" id="paperone_id" name="paper_id" value="{{ $paperoneDetails->id }}">
            <div class="row">
                <div class="col-md-12">
                    <center>
                        <h1 style="color: white; font-weight: bold;">{{ $paperoneDetails->paper_title }}</h1>
                    </center>
                </div>
            </div>
            <br><br><br>
                ...
                <div class="col-md-6 text-center">
                    <div class="left-content">
                        ...
                        <div class="main-button">
                            <a rel="nofollow" href="{{url('/pdf-download-paper-1', $paperoneDetails->id)}}">Download Book</a>
                        </div>
                    </div>
                </div>
{{--                <div class="col-md-6">--}}
