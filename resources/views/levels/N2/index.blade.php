...
@section('content')
    ...
    <div class="container-fluid contact" data-section="section6">
        <br><br><br><br><br><br>
        <center>
            <h1 style="color: aliceblue;">N2</h1>
        </center>
                    ...
                    <div class="col-lg-4 col-md-4 mb-4">
                        <div class="card">
                            <div class="bg-image hover-zoom ripple" data-mdb-ripple-color="light">
                                <img src="{{asset('storage/lessons-image/'.$leveltwo->lesson_image)}}" class="w-100" />
                                <a href="#!">
                                    <div class="mask">
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <a rel="nofollow" class="btn btn-warning" href="{{url('/level-2-pdf-download', $leveltwo->id)}}">Download Book</a>
                            </div>
                        </div>
                    </div>
                @endforeach
