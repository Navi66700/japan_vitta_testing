...
@section('content')
    ...
    <form class="row g-3" method="post" action="{{(route('create-caregiver'))}}"  enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="file" id="image" name="care_image" required>
                <img id="care_image" name="care_image" class="img-fluid rounded" height="100" width="100" src="#">
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function(e) {
            $('#image').change(function() {
                ...
                reader.onload = (e) => {
                    $('#care_image').attr('src', e.target.result);
                }
