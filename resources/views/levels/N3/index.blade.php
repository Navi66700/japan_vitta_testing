...
@section('content')
    ...
    <div class="container-fluid contact" data-section="section6">
        <br><br><br><br><br><br>
        <center>
            <h1 style="color: aliceblue;">N3</h1>
        </center>
        <div class="text-center container py-5">
                    ...
                    <div class="col-lg-4 col-md-4 mb-4">
                        <div class="card">
                            <div class="bg-image hover-zoom ripple" data-mdb-ripple-color="light">
                                <img src="{{asset('storage/lessons-image/'.$levelthree->lesson_image)}}" class="w-100" />
                                <a href="#!">
                                    <div class="mask">
                                    </div>
            ...
            <div class="text-center container py-5">
                <div class="row">
                    @foreach($levelthreeVideos as $levelthreeVideo)
                        <div class="col-lg-4 col-md-4 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    <article class="video-item">
                                        <figure>
                                            <div class="video-container">
                                                <iframe
                                                    src="{{$levelthreeVideo->video_link}}"
                                                    frameborder="0"
